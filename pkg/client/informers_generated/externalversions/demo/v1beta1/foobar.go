	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DemoV1beta1().FooBars(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DemoV1beta1().FooBars(namespace).Watch(options)
			},
		},
		&demov1beta1.FooBar{},
		resyncPeriod,
...
func (f *fooBarInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&demov1beta1.FooBar{}, f.defaultInformer)
}

func (f *fooBarInformer) Lister() v1beta1.FooBarLister {
	return v1beta1.NewFooBarLister(f.Informer().GetIndexer())
}
